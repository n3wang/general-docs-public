...
Currently completing the following: (one softwre + one cfa recccomend)
- React [[r0 - react-index]]
- Calculus - [[c0 - index]]
- CFA - [[MX Template]]
...
- [ ] 7:30 Any Focus/pomodoro 1 max lecture per bloc, skip to the end if not finished at time. Fill in with the concpet learned.: 1 [Block](https://app.focusmate.com/dashboard) [Kaplan](https://www.kaplanlearn.com/education/dashboard/index/ea32a836a0c199956fda01d5683df5f4/course/112133723/) => [[MX Template]] Or complete the [[1 - Learning Flashcards and Books Patterns]]
	- [ ] 1: 
	- [ ] 2: 
	- [ ] 3: 
...
- On Friday, Gonzalo assisted me into onboarding me into splunk and today so that today I should be able to continue with the Spike Analizis without any blockers
- Sevone 126